...
This is a fork of https://github.com/jacksonliam/mjpg-streamer to work as Relay for Octopi's mjpg streamer.
...
* input_file
* input_http(modified to work with Octoprint) ([documentation](mjpg-streamer-experimental/plugins/input_http/README.md))
...
./mjpg_streamer -o "output_http.so -w ./www" -i "input_http.so --host 192.168.178.x --port 80"
```
